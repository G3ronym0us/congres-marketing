...
export default function Profile() {
  const conferencista: Conferencista = {
    ...
    descripcion: "Director, editor de cine y estratega creativo. Cofundador de la agencia de marketing político El Día D. Ganador del Napolitan Victory Awards en 6 ocasiones y es un referente del storytelling político. Jugó un papel fundamental en la campaña presidencial de Rodolfo Hernández en 2022, por el cual ha sido reconocido y premiado por la academia. En la industria publicitaria ha colaborado con Pepsi, Samsung, Alpina, Bavaria, Bancolombia y Claro. En su filmografía se cuentan más de 50 obras que han logrado reconocimiento internacional en festivales como Clermont Ferrand, Friburgo, Tallinn y han sido expuestas en ventanas tan importantes como el Museo de Arte Moderno de Nueva York.",
    roles: [
        "Director",
        "Editor de cine",
        "Estratega creativo",
        "Cofundador de la agencia de marketing político El Día D"
    ],
    redesSociales: {
        Instagram: "https://www.instagram.com/marcoantoniofo?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
    }
};
