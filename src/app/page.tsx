...
export default function Landing() {
  ...
  const mensajeCompra = "Para realizar la compra, comunícate directamente con los administradores al WhatsApp: +57 318 120 0000";

  return (
    <>
      <Head>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="facebook-domain-verification" content="jt2ot27pe1huad2jmb79us4h59gucj" />
        <title>Congreso Nacional de Marketing Político - Colombia 2025</title>
        <meta name="description" content="CNMP 2025 – Donde nacen las campañas ganadoras. El evento más importante de marketing político en Cartagena, Colombia." />
      </Head>
      <Navbar transparent={!showNav} />
      <main> {/* Añadido padding-top para evitar que el contenido quede bajo la navbar */}
        {/* Hero Section */}
        <div
            ...
            <div className="flex flex-wrap items-center">
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center md:text-left">
                <h1 className="text-white font-bold text-4xl md:text-5xl xl:text-6xl leading-tight mb-6">
                  CNMP 2025<br />
                  <span className="text-blue-300">Donde nacen las campañas ganadoras</span>
                </h1>
                <p className="mt-4 text-lg text-gray-300 max-w-lg mx-auto md:mx-0">
                  El poder no se improvisa. Se construye con estrategia, con narrativa, con inteligencia. El Congreso Nacional de Marketing Político vuelve en su tercera edición para redefinir lo que significa hacer política en el siglo XXI. Un encuentro para quienes entienden que ganar elecciones es solo el primer paso.
                </p>
                ...
                <div className="mt-8 text-gray-300">
                  <p className="text-lg">En 2025, Cartagena será testigo de un evento sin precedentes:</p>
                  <ul className="list-none mt-4 space-y-2">
                    ...
                    <li className="flex items-center">
                      <span className="text-blue-300 mr-2">✔</span>
                      <span>Y una comunidad que no cree en lo ordinario y tradicional.</span>
                    </li>
                  </ul>
                  <p className="mt-4 font-semibold">👉 Si tú no estás, tu competencia sí lo estará.</p>
                </div>
              </div>
              ...
              <div className="w-full lg:w-5/12 px-4 mt-12 lg:mt-0">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-4 -right-4 bg-[#1C2C67] text-white px-6 py-3 rounded-lg shadow-lg">
                    <div className="text-sm uppercase tracking-wide">Edición</div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto mt-4">
                El CNMP2025 reúne a los grandes nombres del marketing político internacional. No vienen a repetir fórmulas. Vienen a revelar lo que realmente funciona.
              </p>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {conferencistasInternacionales.filter(c => c.titulo).map((conferencista, index) => (
                  <div 
                    key={index}
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-center mb-3">
                        <h3 className="text-xl font-bold text-white">{conferencista.nombre}</h3>
                      ...
                      <p className="text-blue-300 mb-4">"{conferencista.titulo}"</p>
                      <div className="flex space-x-3">
                        {conferencista.redesSociales.Instagram && (
                          <a href={conferencista.redesSociales.Instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                        ...
                        {conferencista.redesSociales.Facebook && (
                          <a href={conferencista.redesSociales.Facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        {conferencista.redesSociales.X && (
                          <a href={conferencista.redesSociales.X} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {conferencistasNacionales.filter(c => c.titulo).map((conferencista, index) => (
                  <div 
                    key={index}
                  ...
                  >
                    <h3 className="text-lg font-bold text-white mb-1">{conferencista.nombre}</h3>
                    <div className="mb-4">
                      <img 
                        src={`/images/2024/${conferencista.alt}.jpg`}
                        alt={conferencista.nombre}
                    ...
                    <p className="text-blue-300 text-sm mb-4">{conferencista.titulo}</p>
                    <div className="flex space-x-3">
                        {conferencista.redesSociales.Instagram && (
                          <a href={conferencista.redesSociales.Instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="bg-gradient-to-r from-[#1C2C67]/30 to-[#4B0012]/30 p-6 rounded-xl border border-white/10">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-white">Panel de precandidatos presidenciales 2026</h3>
              </div>
              <p className="text-gray-300">
                Un encuentro inédito para analizar el futuro político del país, moderado por un periodista de renombre.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="dirigido-a" className="py-16 bg-black">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 text-center mb-10 max-w-3xl mx-auto">
              Solo quienes juegan para ganar. Este congreso no es para curiosos, ni para espectadores.
              Es para quienes saben que la política cambió, y quieren cambiar con ella.
            </p>
            
            <div className="max-w-4xl mx-auto">
              <h3 className="text-2xl font-semibold text-white mb-6 flex items-center">
                <span className="text-blue-300 mr-2">🎯</span> Este evento es para ti si:
              </h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {audienciaObjetivo.map((item, index) => (
                  <div key={index} className="flex items-start bg-gradient-to-br from-[#1C2C67]/20 to-[#4B0012]/20 backdrop-filter backdrop-blur-sm p-6 rounded-xl">
              ...
              <div className="mt-10 bg-gradient-to-br from-[#1C2C67]/30 to-[#4B0012]/30 p-6 rounded-xl border border-white/10">
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="text-xl font-semibold text-white">Lo que ocurre en el CNMP</h3>
                </div>
                <p className="text-gray-300">
                  Aquí se habla de estrategia, se diseccionan campañas, se revelan errores y se comparten victorias. Si estás en ese juego: este es tu lugar.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Entradas */}
        <section id="entradas" className="py-16 bg-gradient-to-r from-[#0f1424] to-[#1a0a12]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-filter backdrop-blur-sm p-6 rounded-xl border border-white/20">
                ...
                <h3 className="text-2xl font-bold text-white text-center mb-2">General</h3>
                <p className="text-gray-300 text-center mb-6">Acceso completo a conferencias + gala exclusiva.</p>
                <div className="relative">
                  <button 
              ...
              {/* VIP */}
              <div className="bg-gradient-to-br from-[#1C2C67]/50 to-[#4B0012]/50 backdrop-filter backdrop-blur-sm p-8 rounded-xl border-2 border-purple-500 transform scale-105 shadow-xl relative">
                ...
                <h3 className="text-2xl font-bold text-white text-center mb-2">VIP Estratégico</h3>
                <p className="text-gray-300 text-center mb-6">Acceso prioritario + Mejor ubicación en auditorio + gala exclusiva + memorias del evento.</p>
                <div className="relative">
                  <button 
              ...
              <div className="bg-white/10 backdrop-filter backdrop-blur-sm p-6 rounded-xl border border-white/20">
                ...
                <h3 className="text-2xl font-bold text-white text-center mb-2">Estudiantes</h3>
                <p className="text-gray-300 text-center mb-6">Tarifa preferencial (cupos limitados – con carnet vigente).</p>
                <div className="relative">
                  <button 
                    className="w-full bg-white text-[#1C2C67] font-semibold py-3 px-6 rounded-lg opacity-75 cursor-not-allowed"
                    onMouseEnter={() => setShowTooltip(true)}
            ...
            <div className="mt-12 bg-white/5 p-6 rounded-xl max-w-3xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-center md:text-left">
                  <h4 className="text-lg font-semibold text-white mb-2">Medios de pago</h4>
                  <p className="text-gray-400">PSE, tarjeta crédito/débito, transferencia</p>
                </div>
                <div className="text-center md:text-right">
                  <p className="text-yellow-300 font-semibold">⚠️ Este no es un evento masivo. Es una experiencia para mentes selectas.</p>
                  <p className="text-white">Asegura tu cupo antes de que se agote.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="testimonios" className="py-16 bg-black">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Lo que dicen los que ya estuvieron</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-[#1C2C67]/20 to-[#4B0012]/20 backdrop-filter backdrop-blur-sm p-6 rounded-xl">
                ...
                <p className="text-gray-300 mb-6 text-lg italic">
                  "Fui como candidato. Salí como ganador."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#1C2C67] to-[#4B0012]"></div>
                  <div className="ml-4">
                    <h4 className="text-white font-semibold">Carlos Gómez</h4>
                    <p className="text-gray-400 text-sm">Alcalde electo 2023</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1C2C67]/20 to-[#4B0012]/20 backdrop-filter backdrop-blur-sm p-6 rounded-xl">
                <div className="text-2xl text-blue-300 mb-4">🎤</div>
                <p className="text-gray-300 mb-6 text-lg italic">
                  "Ver a Beccassino, Sola y Guinand juntos fue un masterclass de realidad política."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#1C2C67] to-[#4B0012]"></div>
                  <div className="ml-4">
                    <h4 className="text-white font-semibold">Valentina Ruiz</h4>
                    <p className="text-gray-400 text-sm">Consultora Electoral</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1C2C67]/20 to-[#4B0012]/20 backdrop-filter backdrop-blur-sm p-6 rounded-xl">
                <div className="text-2xl text-blue-300 mb-4">🎤</div>
                <p className="text-gray-300 mb-6 text-lg italic">
                  "Volví con una nueva campaña… y con una nueva forma de pensar el poder."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#1C2C67] to-[#4B0012]"></div>
                  <div className="ml-4">
                    <h4 className="text-white font-semibold">Andrés Páez</h4>
                    <p className="text-gray-400 text-sm">Director de comunicaciones</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mt-10">
              <p className="text-xl text-white font-semibold">👉 ¿Listo para escribir tu propio testimonio?</p>
              <div className="relative inline-block mt-6">
                <button 
                  className="bg-gradient-to-r from-[#1C2C67] to-[#4B0012] text-white font-semibold py-3 px-8 rounded-lg opacity-75 cursor-not-allowed"
                  onMouseEnter={() => setShowTooltip(true)}
                  onMouseLeave={() => setShowTooltip(false)}
                  onClick={(e) => e.preventDefault()}
                  title={mensajeCompra}
        ...
        {/* Aliados */}
        <section id="aliados" className="py-16 bg-gradient-to-b from-black to-[#0f1424]">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-6">
              ...
              <p className="text-xl text-gray-300 text-center mb-10">
                Formar parte del CNMP2025 como aliado estratégico es conectarse con:
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white/10 backdrop-filter backdrop-blur-sm p-6 rounded-lg text-center">
                  <div className="text-4xl mb-4">👥</div>
                  <h3 className="text-white font-semibold mb-2">Una comunidad de +500 líderes</h3>
                  <p className="text-gray-400">del mundo electoral</p>
                </div>
                
                <div className="bg-white/10 backdrop-filter backdrop-blur-sm p-6 rounded-lg text-center">
                  <div className="text-4xl mb-4">🔄</div>
                  <h3 className="text-white font-semibold mb-2">Un ecosistema de decisión política</h3>
                  <p className="text-gray-400">en Colombia y LATAM</p>
                </div>
                
                <div className="bg-white/10 backdrop-filter backdrop-blur-sm p-6 rounded-lg text-center">
                  <div className="text-4xl mb-4">👁️</div>
                  <h3 className="text-white font-semibold mb-2">Visibilidad ante 2.5 millones</h3>
              ...
              <div className="text-center">
                <p className="text-gray-300 mb-4">
                  <span className="text-blue-300 mr-1">📩</span> Solicita nuestro portafolio de patrocinio al correo:
                </p>
                <a href="mailto:cnmpcolombia@gmail.com" className="text-white text-xl font-semibold hover:text-blue-300 transition-colors">
        ...
        {/* Contacto */}
        <section id="contacto" className="py-16 bg-[#0f1424]">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:cnmpcolombia@gmail.com" className="text-white hover:text-blue-300 transition-colors">
                          cnmpcolombia@gmail.com
                        </a>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <span className="text-blue-300 mr-3">📱</span>
                      <div>
                        <p className="text-gray-300">WhatsApp / Teléfono comercial:</p>
                        <a href="tel:+573181200000" className="text-white hover:text-blue-300 transition-colors">
                          +57 318 120 0000
                        </a>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="https://www.instagram.com/asocopol" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300 transition-colors">
                          @asocopol
                        </a>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300 transition-colors">
                ...
                <div className="bg-gradient-to-br from-[#1C2C67]/20 to-[#4B0012]/20 backdrop-filter backdrop-blur-sm p-6 rounded-xl">
                  <h3 className="text-xl font-semibold text-white mb-6">Director general</h3>
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[#1C2C67] to-[#4B0012]"></div>
                    <div className="ml-4">
                      <h4 className="text-white font-semibold">José Guinand</h4>
                    </div>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:joseguinandc@gmail.com" className="text-white hover:text-blue-300 transition-colors">
                          joseguinandc@gmail.com
                        </a>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="tel:+573183099427" className="text-white hover:text-blue-300 transition-colors">
                          +57 318 309 9427
                        </a>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="https://www.instagram.com/guinandestrategia" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300 transition-colors">
                          @guinandestrategia
                        </a>
                      </div>
                    </li>
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold text-white mb-4">🖋️ Aliados institucionales</h3>
                <p className="text-gray-300">
                  Asociación Nacional de Consultores Políticos – ACEIPOL – Revista Jaque Mate – Politólogos Digitales – Voz Consultores
                </p>
              </div>
            </div>
          </div>
